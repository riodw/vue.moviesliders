      ...
      <div class="container base_container">
        <div id="wbars">
          <div class="content legal_pp">
            <div class="header">
              <h1
                >Privacy Policy of <strong>moviesliders.com</strong> and
                <strong>MovieSliders</strong> app</h1
              >
                ...
                <li>
                  ...
                  <ul class="unstyled">
                    <li>
                      ...
                      <p>
                        Personal Data: Application opens; Application updates; Cookies;
                        device information; first launches; geography/region; In-app
                        purchases; number of sessions; number of Users; operating
                        systems; session duration; unique device identifiers for
                ...
                <li>
                  ...
                  <ul class="unstyled">
                    <li>
                      <h3>App Center</h3>
                      <p>
                        Personal Data: Data communicated while using the service; email
                        address; various types of Data as specified in the privacy
                  ...
                  <div class="iconed policyicon_purpose_9">
                    ...
                    <ul class="unstyled">
                      <li>
                        ...
                        <p>
                          Personal Data: email address; first name; last name; profile
                          picture; username
                        </p>
                      </li>
                    </ul>
            ...
            <div class="one_line_col">
              ...
              <p>
                ...
                itself or through third parties, there are: first name; last name; email
                address; profile picture; username; Usage Data; device information;
                number of Users; number of sessions; session duration; Application
                opens; Application updates; operating systems; Cookies; unique device
                identifiers for advertising (Google Advertiser ID or IDFA, for example);
                geography/region; In-app purchases; first launches; Data communicated
              ...
              <p>
                ...
                texts displayed prior to the Data collection.<br />Personal Data may be
                freely provided by the User, or, in case of Usage Data, collected
                automatically when using this Application.<br />Unless specified
                ...
                functioning of the Service.<br />Users who are uncertain about which
                Personal Data is mandatory are welcome to contact the Owner.<br />Any
            ...
            <div class="one_line_col">
              ...
              <p>
                ...
                Data.<br />The Data processing is carried out using computers and/or IT
              ...
              <p>
                ...
                places where the parties involved in the processing are located.<br /><br />
              ...
              <p>
                ...
                the performance of a legal obligation or upon order of an authority.<br /><br />
            ...
            <div class="one_line_col">
              ...
              <p>
                ...
                the following: Registration and authentication, Platform services and
                hosting, Analytics and Beta Testing.
              </p>
              <p>
                    ...
                    <div class="expand-content">
                      ...
                      <div class="wrap">
                        <p>
                          ...
                          Limited, depending on the location this Application is
                          accessed from.<br />
                          <strong>
                        ...
                        <p>
                          ...
                          Firebase, such as Crash Reporting, Authentication, Remote
                          Config or Notifications. The User may check this privacy
                          policy to find a detailed explanation about the other tools
                          used by the Owner.
                        </p>
                        <p>
                          This Application uses identifiers for mobile devices and
                          technologies similar to cookies to run the Firebase Analytics
                          service.
                        </p>
                        <p>
                          Users may opt-out of certain Firebase features through
                          applicable device settings, such as the device advertising
                          settings for mobile phones or by following the instructions in
                          other Firebase related sections of this privacy policy, if
                          available.
                        </p>
                      </div>
                      <p>
                        Personal Data processed: Application opens; Application updates;
                        Cookies; device information; first launches; geography/region;
                        In-app purchases; number of sessions; number of Users; operating
                        systems; session duration; unique device identifiers for
                        advertising (Google Advertiser ID or IDFA, for example); Usage
                        Data.
                      </p>
                  ...
                  <div class="box_primary box_10 expand">
                    ...
                    <div class="expand-content">
                      <p>
                        ...
                        this Application, or parts of it, for the purpose of testing a
                        certain feature or the entire Application.<br />
                      ...
                      <div class="wrap">
                        <p>
                          ...
                          Corporation. This Application may also send push notifications
                          to the User.
                        </p>
                      </div>
                      <p>
                        Personal Data processed: Data communicated while using the
                        service; email address; various types of Data as specified in
                    ...
                    <div class="expand-content">
                      ...
                      <div class="wrap">
                        ...
                        <p>
                          ...
                          collects basic analytics and provides reporting features that
                          enables the Owner to view usage analytics data and measure the
                          performance of this Application. Much of this information is
                          processed on an opt-in basis.
                        </p>
                        <p>
                          Users may opt-out of this analytics feature directly through
                  ...
                  <div class="box_primary box_10 expand">
                    ...
                    <div class="expand-content">
                      <p>
                        ...
                        to identify them and give them access to dedicated services.<br />
                      ...
                      <div class="wrap">
                        <p>
                          ...
                          service provided by Google LLC or by Google Ireland Limited,
                          depending on the location this Application is accessed from.
                          To simplify the registration and authentication process,
                          Firebase Authentication can make use of third-party identity
                          providers and save the information on its platform.
                        </p>
                      </div>
                      <p>
            ...
            <div class="one_line_col">
              ...
              <ul>
                ...
                <li>
                  ...
                  Users have the right to object to the processing of their Data if the
                  processing is carried out on a legal basis other than consent. Further
                  details are provided in the dedicated section below.
                </li>
                <li>
                  <b> Access their Data. </b>
                  Users have the right to learn if Data is being processed by the Owner,
                ...
                <li>
                  ...
                  Users have the right to verify the accuracy of their Data and ask for
            ...
            <div class="one_line_col">
              ...
              <p>
                ...
                improper use of this Application or the related Services.<br />The User
